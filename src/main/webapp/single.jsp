    ...
    <script>
        $(window).load(function () {
            $("#addcart").click(function () {
               var cart= $("#count").val();
               location = "checkout?id=${requestScope.idmap.ID}&cart="+cart;
            })
        })
    </script>
   <%-- <script type="text/javascript">
        $(function () {
            $("input[name='cart']").onclick(function () {
            ...
            <div class="single_left">
                <div class="labout span_1_of_a1">
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb=${requestScope.imgmap.IMG_01}>
                                <img src="${requestScope.imgmap.IMG_01}" />
                            </li>
                            <li data-thumb="${requestScope.imgmap.IMG_02}">
                                <img src="${requestScope.imgmap.IMG_02}" />
                            </li>
                            <li data-thumb="${requestScope.imgmap.IMG_03}">
                                <img src="${requestScope.imgmap.IMG_03}" />
                            </li>
                            <li data-thumb="${requestScope.imgmap.IMG_04}">
                                <img src="${requestScope.imgmap.IMG_04}" />
                            </li>
                        </ul>
                    </div>
                    <div class="clearfix"></div>T_ID
                </div>
                <div class="cont1 span_2_of_a1 simpleCart_shelfItem">
                    <h1>${requestScope.idmap.NAME}</h1>
                    <p class="availability">Availability: <span class="color">In stock</span></p>
                    <div class="price_single">
                        <span class="reducedfrom">$${requestScope.idmap.PRICE}</span>
                        <span class="amount item_price actual">$${requestScope.idmap.MONEY}</span><a href="#">click for offer</a>
                    </div>
                    <h2 class="quick">快速查看:</h2>
                    <p class="quick_desc">${requestScope.idmap.MESSAGE}</p>
                    <div class="wish-list">
                        <ul>
                    ...
                    <ul class="size">
                        <h3>Length</h3>
                        <li><a href="#">${requestScope.idmap.LENGTH}</a></li>
                        <li><a href="#">34</a></li>
                    </ul>
                    ...
                    <a href="#" class="btn btn-primary btn-normal btn-inline btn_form button item_add item_1" name="cart" target="_self" id="addcart">添加到购物车</a>
                    <span ></span>
                </div>
                <div class="clearfix"> </div>
            </div>
