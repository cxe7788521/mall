        ...
        <div class="col-md-9 single_top">
            ...
            <div class="brand_box">
                ...
                <div class="right-side col-xs-12 col-sm-4">
                    ...
                    <a href="brands?id=3" class="btn btn1 btn-primary btn-normal btn-inline " target="_self">View Products</a>
                </div>
                <div class="clearfix"> </div>
            </div>
            <div class="brand_box">
                ...
                <div class="right-side col-xs-12 col-sm-4">
                    ...
                    <a href="brands?id=7" class="btn btn1 btn-primary btn-normal btn-inline " target="_self">View Products</a>
                </div>
                <div class="clearfix"> </div>
            </div>
            <div class="brand_box">
                <div class="left-side col-xs-12 col-sm-3">
                    <img src="images/jiangshidandun.jpg" alt=""/>
                </div>
                <div class="middle-side col-xs-12 col-sm-5">
                ...
                <div class="right-side col-xs-12 col-sm-4">
                    ...
                    <a href="brands?id=5" class="btn btn1 btn-primary btn-normal btn-inline " target="_self">View Products</a>
                </div>
                <div class="clearfix"> </div>
            </div>
            <div class="brand_box">
                <div class="left-side col-xs-12 col-sm-3">
                    <img src="images/langqin.jpg" alt=""/>
                </div>
                <div class="middle-side col-xs-12 col-sm-5">
                ...
                <div class="right-side col-xs-12 col-sm-4">
                    ...
                    <a href="brands?id=1" class="btn btn1 btn-primary btn-normal btn-inline " target="_self">View Products</a>
                </div>
                <div class="clearfix"> </div>
            </div>
        </div>
