            ...
            $("input[name='username']").blur(function () {
                ...
                $.ajax({
                    ...
                    success:function(result){
                        $("#yonghuming").text(result.msg);


                },
                    error:function (error) {
                        $("#yonghuming").text(error.msg);
...
<div class="account-in">
    <div class="container">
            <div class="register-top-grid">
                ...
                <div>
                            <input type="text" name="username" placeholder="用户名" required></input>
                            <span id="yonghuming"></span>

                </div>
                <div>
                    <input type="text" name="t_gender" required placeholder="性别"></input>
                </div>
                <div>
                    <input type="text" name="t_id_card" required placeholder="身份证"></input>
                </div>
                <div class="clearfix"> </div>
                <a class="news-letter" href="#">
                    <label class="checkbox"><input type="checkbox" required name="checkbox" checked=""><i> </i>Sign Up for Newsletter</label>
                </a>
            </div>
            <div class="register-bottom-grid">
                <h2>LOGIN INFORMATION</h2>
                <div>
                    <input type="password" name="t_password" placeholder="密码" required></input>
                </div>
                <div>
                    <input type="password" name="pw2" placeholder="再次输入密码" required></input>
                </div>
                <div class="clearfix"> </div>
            </div>
        <div class="clearfix"> </div>
